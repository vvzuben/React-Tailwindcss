    ...
    return (
        <div className='flex max-xl:flex-col max-xl:justify-center max-xl:items-center bg-primary min-h-[941px] gap-10'>
            <div className='w-1/2 max-xl:w-full mt-auto'>
                <Image src="/images/contactus.png" alt=":)Not Found" width={834} height={801}
            ...
            <div className='w-1/2 max-xl:w-full'>
                <form className='bg-gray p-12 max-w-[635px] h-[801px] pt-[140px] max-xl:m-auto'>
                    <p className="text-[#4FAFE0] text-5xl max-sm:text-4xl">WOULD YOU LIKE TO DISCUSS YOUR PROJECT?</p>
